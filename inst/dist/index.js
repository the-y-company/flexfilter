      ...
      timeout = setTimeout(() => {
        ...
        $(`#${this.ns}-variables`)
          ...
          .each((i, el) => {
            ...
            value += " " + $(el).find("a").text().toLowerCase();
